...
public:
    ...
    // Short rationale for estimate: count is constant
    int place_count();
    ...
    // Estimate of performance: O(n)
    // Short rationale for estimate: iterating over unordered map is linear
    std::vector<PlaceID> all_places();

    // Estimate of performance: O(n) ~ Theta(1)
    // Short rationale for estimate: Find and insert is constant on average.
    ...
    // Short rationale for estimate: There is std::sort() in the function
    ...
    // Estimate of performance: O(n)
    // Short rationale for estimate: For loop makes it linear
    ...
    // Estimate of performance: O(1)
    // Short rationale for estimate: Find and insert is constant
    ...
    // Estimate of performance: O(1)
    // Short rationale for estimate: Finding and pushing back in vector is constant
    ...
    // Estimate of performance: O(1)
    // Short rationale for estimate: find and erase are constant.
    bool remove_place(PlaceID id);

    // Estimate of performance: O(n^2)
    // Short rationale for estimate: two nested for loops makes it n^2
...
private:
    ...
    void go_through_parentareas(AreaID id);

    std::vector<AreaID> subAreas;
    void go_through_subareas(AreaID id);
};
